...
@section('content')
    ...
    <h3 class="i-name">{{ __('messages.Referees') }}</h3>
    ...
    <script>
        ...
        $(document).on('click','#SearchButton', function(){
            ...
            {
                window.location.href="{{ route('Referees') }}";
            }
        });
        ...
        $(document).on('click','.Details', function(){
            ...
            let currentRow=$(this).closest("tr");
            let RefereeId = currentRow.find("td:eq(0)").text(); // get current Id

            document.cookie  = "RefereeId = " + RefereeId;

            window.location.href="{{ route('RefereeDetails') }}";
        ...
        $(document).on('click','.Edit', function(){
            ...
            $("#editRefereeModal").find('input[name="UserId"]').val(UserId);
