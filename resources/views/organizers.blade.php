...
@section('content')
    ...
    <h3 class="i-name">{{ __('messages.Organizers') }}</h3>
    ...
    <script>
        ...
        $(document).on('click','.Details', function(){
            ...
            let OrganizerId = currentRow.find("td:eq(0)").text(); // get current Id

            document.cookie  = "OrganizerId = " + OrganizerId;

            window.location.href="{{ route('OrganizersDetails') }}";
        ...
        $(document).on('click','.Edit', function(){
            ...
            let Category = currentRow.find("td:eq(2)").text(); // get current Category
            ...
            $("#editOrganizersModal").find('input[name="UserId"]').val(UserId);
            $("#editOrganizersModal").find('input[name="Name"]').val(Name);
            $("#editOrganizersModal").find('input[name="Category"]').val(Category);
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '#All', function () {
                ...
                window.location.href="{{ route('Organizers') }}";
            });
