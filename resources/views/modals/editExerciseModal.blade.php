...
<div class="modal" id="editExerciseModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('editExercises') }}" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="form-group">
                        <input id="Id" type="text" class="form-control" name="Id" hidden>
                        <label for="recipient-name" class="col-form-label">{{ __('messages.ExerciseTopic') }}: @error('Topic') <small id="ErrorName" class="form-text text-danger">{{ $message }}</small> @enderror</label>
                        <input id="Topic" type="text" class="form-control" name="Topic" value="{{ old('Topic') }}" required autofocus>
                    </div>
                    <div class="form-group">
                        <label for="recipient-name" class="col-form-label">{{ __('messages.ExerciseType') }}: @error('ExerciseType') <small id="ErrorEmail" class="form-text text-danger">{{ $message }}</small> @enderror</label>
                        <input id="ExerciseType" type="text" class="form-control" name="ExerciseType" value="{{ old('ExerciseType') }}">
                    </div>
                    <div>
                    ...
                    <div class="form-group">
                        <label for="recipient-name" class="col-form-label">{{ __('messages.ExerciseDate') }}: @error('ExerciseDate') <small id="ErrorEmail" class="form-text text-danger">{{ $message }}</small> @enderror</label>
                        <input id="ExerciseDate" type="date" class="form-control" name="ExerciseDate" value="{{ old('ExerciseDate') }}">
                    </div>
                    <div class="form-group">
