...
<div class="modal" id="editMatchModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('editMatches') }}" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="form-group">
                        <input id="Id" type="text" class="form-control" name="Id" hidden>
                        <label for="recipient-name" class="col-form-label">{{ __('messages.MatchTopic') }}: @error('Topic') <small id="ErrorName" class="form-text text-danger">{{ $message }}</small> @enderror</label>
                    ...
                    <div class="form-group">
                        <label for="recipient-name" class="col-form-label">{{ __('messages.MatchDate') }}: @error('MatchDate') <small id="ErrorEmail" class="form-text text-danger">{{ $message }}</small> @enderror</label>
                        <input id="MatchDate" type="date" class="form-control" name="MatchDate" value="{{ old('MatchDate') }}">
                    </div>
                    <div class="form-group">
