...
<div class="modal" id="editOrganizersModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('editOrganizers') }}" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    ...
                    <div>
                        <label for="recipient-name" class="col-form-label">{{ __('messages.Category') }}: @error('Category') <small id="ErrorName" class="form-text text-danger">{{ $message }}</small> @enderror</label>
