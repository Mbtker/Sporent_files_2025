...
<div class="modal" id="editStoreModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('editStores') }}" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    ...
                    <div>
                        <label for="recipient-name" class="col-form-label">{{ __('messages.OwnerName') }}: @error('OwnerName') <small id="ErrorName" class="form-text text-danger">{{ $message }}</small> @enderror</label>
                        <input id="OwnerName" type="text" class="form-control" name="OwnerName" value="{{ old('OwnerName') }}">
                    </div>
                    <div>
                        <label for="recipient-name" class="col-form-label">{{ __('messages.OwnerPhone') }}: @error('OwnerPhone') <small id="ErrorPhone" class="form-text text-danger">{{ $message }}</small> @enderror</label>
                        <input id="OwnerPhone" type="number" class="form-control" name="OwnerPhone" value="{{ old('OwnerPhone') }}">
                    </div>
                    <div>
