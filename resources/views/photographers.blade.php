...
@section('content')
    ...
    <h3 class="i-name">{{ __('messages.Photographers') }}</h3>
    ...
    <script>
        ...
        $(document).on('click','#SearchButton', function(){
            ...
            {
                jQuery.ajax({
                    url: "{{ url('/PhotographersSearching') }}",
                    method: 'get',
                    data: {
        ...
        $(document).on('click','.Details', function(){
            ...
            let PhotographerId = currentRow.find("td:eq(0)").text(); // get current Id

            document.cookie  = "PhotographerId = " + PhotographerId;

            window.location.href="{{ route('PhotographerDetails') }}";
        ...
        $(document).on('click','.Edit', function(){
            ...
            $("#editPhotographersModal").find('input[name="UserId"]').val(UserId);
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '#All', function () {
                ...
                window.location.href="{{ route('Photographers') }}";
            });
