<div class="boardView_details">
    ...
    <table style="width: 100%">
        ...
        <tr>
            ...
            <td style="min-width: 200px">{{ __('messages.ExerciseTopic') }}</td>
            <td style="text-align: center; width: 150px">{{ __('messages.ExerciseType') }}</td>
            ...
            <td style="text-align: center">{{ __('messages.CreatBy') }}</td>
            <td style="display: none">CreatById</td>
            <td style="text-align: center">{{ __('messages.Fee') }}</td>
            <td style="text-align: center; display: none">{{ __('messages.Fee') }}</td>
            <td style="text-align: center">{{ __('messages.ExerciseDate') }}</td>
        ...
        @if (isset($MyArray))
            @foreach($MyArray as $Item)
                <tr>
                    ...
                    <td style="text-align: center">{{ $Item->{'ExerciseType'} }}</td>
                    ...
                    <td style="text-align: center"><a id="CreatByDetails" style="text-decoration: none; color: black" href="#">{{ $Item->{'CreatByName'} }}</a></td>
                    <td style="display: none">{{ $Item->{'CreatById'} }}</td>
                    ...
                    <td style="text-align: center">{{ Carbon\Carbon::parse($Item->{'ExerciseDate'})->format('Y-m-d') }}</td>
