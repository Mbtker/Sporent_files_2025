<div class="boardView_details">
    ...
    <table style="width: 100%">
        ...
        <tr>
            ...
            <td style="text-align: center">{{ __('messages.Team') }}</td>
            <td style="text-align: center; display: none">TeamId</td>
            ...
            <td style="text-align: center; width: 95px; display: none">StatusId</td>
        ...
        @if (isset($MyArray))
            @foreach($MyArray as $Item)
                <tr>
                    ...
                    <td style="text-align: center"><a id="TeamDetails" style="text-decoration: none; color: black" href="#">{{ $Item->{'TeamName'} }}</a></td>
                    <td style="display: none">{{ $Item->{'TeamId'} }}</td>
