    ...
    <div class="content">
        <div class="top_card">
            ...
            <div class="info_row_logo">
                <img src="@if($MyArray->Logo != null) {{ $MyArray->Logo }} @else {{ URL::asset('images/stadiums_icon.png') }} @endif"  alt="team_logo"/>
            </div>
            <div class="info_row">
                <div class="mt-2">
        ...
        $(document).on('click','.EditInfo', function(){
            ...
            jQuery.ajax({
                ...
                success: function(result){
                    ...
                    $("#editStadiumsModal").find('input[name="UserId"]').val(Id);
